  ...
  "node_modules/openseadragon/build/openseadragon/openseadragon.js"(exports, module) {
    ...
    (function($) {
      $.Tile = function(level, x, y, bounds, exists, url, context2D, loadWithAjax, ajaxHeaders, sourceBounds, postData, cacheKey) {
        ...
        if (cacheKey === void 0) {
          $.console.error("Tile constructor needs 'cacheKey' variable: creation tile cache in Tile class is deprecated. TileSource.prototype.getTileHashKey will be used.");
    ...
    (function($) {
      ...
      $.extend($.TiledImage.prototype, $.EventSource.prototype, {
        ...
        _getTile: function(x, y, level, time, numTiles, worldWidth, worldHeight) {
          var xMod, yMod, bounds, sourceBounds, exists, url, post, ajaxHeaders, context2D, tile, tilesMatrix = this.tilesMatrix, tileSource = this.source;
        ...
        _drawTiles: function(lastDrawn) {
          ...
          var useSketch;
          if (tile) {
            useSketch = this.opacity < 1 || this.compositeOperation && this.compositeOperation !== "source-over" || !this._isBottomItem() && tile._hasTransparencyChannel();
          }
          var sketchScale;
          var sketchTranslate;
            ...
            try {
              var polygons = this._croppingPolygons.map(function(polygon) {
                return polygon.map(function(coord) {
                  var point = this.imageToViewportCoordinates(coord.x, coord.y, true).rotate(-this.getRotation(true), this._getRotationPoint(true));
...
// dep:openseadragon
var openseadragon_default = require_openseadragon();
export {
  openseadragon_default as default
};
//! Built on 2022-06-07
